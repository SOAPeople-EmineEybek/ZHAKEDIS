CLASS zcl_vh_approval_status DEFINITION
...
CLASS ZCL_VH_APPROVAL_STATUS IMPLEMENTATION.


  METHOD if_rap_query_provider~select.
    DATA lt_result TYPE TABLE OF zmmr_vh_approval_status.
    ...
    lt_result = VALUE #(
      ( statuscode = '03' statustext = 'Onay Tamamlanmadı' )
      ( statuscode = '05' statustext = 'Onaylandı' )
    ).
